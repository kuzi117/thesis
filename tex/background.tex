...
\nelson{This opening paragraph no longer corresponds to the content of the chapter.}
...
\bk{
  I moved the content here into \rcha{matmul}
  Jo\~ao suggested this section just be cut and let the chapter introduce everything.
  It feels sort of weird to do so while leaving the MMA section just before this.
}
\nelson{It is fine, just remove everything about this section, including the heading.}
