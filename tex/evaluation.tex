...
Because kernels generated by lowering the \code{llvm.matrix.multiply} intrinsic do not have human supervision, it is unlikely that either of the two kernels compared in this experiment achieve the maximum performance possible.
