...
Only after stripping away certain bottlenecks present in the naive kernel can one learn about new issues that are still to be addressed by the backend design team.
