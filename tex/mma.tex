...
This enables simple circuit pathways where, for a rank-$r$ update, element $(i, j)$ in $C$ accumulates with the dot product of the $r$-length group of elements in $A$ at offset $i \times r$ and in $B$ at $j \times r$.\footnotemark
