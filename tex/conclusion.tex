...
Moreover, a human-crafted kernel is only twice as fast as the current best \gls{lowering} of the \code{llvm.matrix.multiply} intrinsic, a significant achievement.
...
The design of the micro-kernel code generation presented in this thesis uses the \code{llvm.matrix.multiply} intrinsic in \gls{llvm} as an interface.
