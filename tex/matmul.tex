...
\begin{figure}[t]
  ...
  \end{subfigure}
  \hfill
  \caption[Inner Kernel Implementations, In Register]{The two possible implementations for the inner kernel as computed by \glslink{broadcast}{broadcasting} and \acrshort{fma}.}
  \label{fig:gepb}
  \vspace{-0.15cm}
\end{figure}
