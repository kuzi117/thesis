...
\nelson{If you state that the \emph{inner product} is not to be confused with the \emph{dot product} you must also state what is the difference between the two. You do not need to state the difference if you do not mention the dot product.}
...
It is for this reason that \cha{method} presents a method built fully within a compiler without a hand-written kernel.
