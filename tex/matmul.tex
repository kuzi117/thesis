...
This produces three different innermost loops \nelson{I do not understand this notation:} (${}^{3}C_{2}=3$).
...
\nelson{Be consistent on the typesetting that you choose for A, B, and C.}
...
\nelson{Next sentence is not grammatically correct.}
...
\nelson{Do not hide the subject behind the passive voice.}
...
\nelson{Language in this paragraph is very informal. Please re-read and re-write in a more academic fashion.}
