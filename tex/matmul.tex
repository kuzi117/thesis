...
\nelson{The following sentence is not true if we consider a single computation of an outer product or of an inner product. the inner product computes a scalar value and the outer product computes a matrix. I know what your intention is --- the matrix-multiplication computation based on inner-product computations and the one based on outer-product computations produce the same matrix}
...
\nelson{What is the difference between the inner product and the dot product in this paragraph?}
